...
years ago. I found the The tidbits of incoherent information with no trunk to
...
* **Flash cards**. Reviewing flash cards have been a wonderful habit to build
...
flash cards about its history, its people, its cuisine and its culture. A year
later, due to these flash cards, I still remember why Brazil has the largest
Japanese population after Japan, how Brazil got its non-violent independency,
and the rough economic history of the country from Brazilwood, to sugar, to
coffee, and so on. This backbone about the country made conversations with
locals much
more interesting.

As I kept reviewing my flash cards every morning, the number of cards kept
growing. I started using them for food.  Before going to a restaurant, I'd look
up all the items on the menu I had no idea what were and create flash cards for
...
When studying a fact-heavy topic, I'll usually create a handful of flash cards
...
Reviewing flash cards is now an ingrained habit, and it's already helped me
tremendously. [Anki](ankisrs.net), the app I use for flash cards, reports that I
...
just be my favourite culinary destination in the world currently. 
